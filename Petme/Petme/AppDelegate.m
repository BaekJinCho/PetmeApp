...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    FIRUser *user = [DataCenter shreadInstance].auth.currentUser;
...
//        [self.window setRootViewController:[storyboar instantiateViewControllerWithIdentifier:@"PetMeTabBar"]];
    }
